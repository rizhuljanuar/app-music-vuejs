  ...
  <main>
    ...
    <section class="container mx-auto mt-6" id="comments">
      ...
      >
        ...
        <div class="p-6">
          <div class="text-white text-center font-bold rounded p-4 mb-4" v-if="comment_show_alert" :class="comment_alert_variant">
            {{ comment_alert_message }}
          </div>
          <vee-form :validation-schema="schema" @submit="addComment" v-if="isLogginUser">
...
export default {
  ...
  computed: {
    ...mapState(useUserStore, ['isLogginUser']),
